...
const AdminDashboard = () => {
  ...
  const dashboardData = [
    { title: 'Total Courses', value: numberOfCourses, icon: <ListIcon className="dashboard-icon text-blue" />, link: '/admin/courses' },
    { title: 'Total Teachers', value: numberOfTeachers, icon: <img src="icons/computer.svg" className="dashboard-icon" alt="teacher" />, link: '/admin/teachers' },
    { title: 'Total Internal Students', value: numberOfInternalStudents, icon: <img src="icons/schoolIcon.svg" className="dashboard-icon" alt="school" />, link: '/admin/students' },
    { title: 'Total External Students', value: numberOfExternalStudents, icon: <img src="icons/studentIcon.svg" className="dashboard-icon" alt="student" />, link: '/admin/students' },
  ];
